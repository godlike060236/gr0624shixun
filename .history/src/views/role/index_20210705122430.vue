<template>
  <div class="index">
    <div class="gr-filter">
      ...
      <el-button size='medium' type="primary" plain icon="el-icon-plus" style="float: right" @click="add">添加角色
      </el-button>
      <div class="clear"></div>
    </div>
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column>
        <template slot-scope="scope">
          <el-button size="small" plain type="primary" @click="users(scope.ro">关联用户</el-button>
        </template>
      </el-table-column>
